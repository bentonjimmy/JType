...
/**
 * This class is used to display the results of the 15 top scoring games.  The names and 
 * scores are retrieved from an Oracle database.  They are displayed to the screen
...
{
	/**
	 * The ScoreBoard constructor will send the current game's score to the database if
	 * the score is greater than zero.  It will then retrieve the data in tblTopScores.
	 * @param space
	 * @throws SQLException
	 */
	...
	/**
	 * This method is used to draw the names and scores to the screen.  Each time method
	 * is called the initial position is moved up the screen to make it appear
	 * animated.
	 * 
	...
	public void drawBoard(Graphics2D g2)
	{
		...
		for(int i=0; i<names.size(); i++)
		{
			...
			g2.drawString((String)names.get(i) + " " + (String)scores.get(i), 100, y);
			y += divider;
		}
		initY -= 2;
	}
