...
/**
 * This class extends PowerUp and provides a way for the ship to gain more ammo.
 * If the ship collides with the image produced by this class it will receive additional ammo.
 * 
 * @author jmb66
 *
 */
public class MissilePack extends PowerUp 
{
	public MissilePack(JTypeSpace space, int x, int y)
	{
		...
		score = 10;
		hp = 1;
		ImageIcon icon = new ImageIcon(this.getClass().getResource("MissilePack.png"));
		image = icon.getImage();
