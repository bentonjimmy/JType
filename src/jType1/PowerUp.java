...
/**
 * PowerUp class implements the SpaceObject interface and defines basic methods that 
 * each PowerUp type will have.  It provides the abstract method <code>givePowerUp</code> that must be
