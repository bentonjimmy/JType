...
/**
 * This class extends PowerUp and provides a way for the player to gain health points if it 
...
public class HealthPack extends PowerUp 
{
	public HealthPack(JTypeSpace space, int x, int y)
	{
		...
		score = 10;
		hp = 1;
		ImageIcon icon = new ImageIcon(this.getClass().getResource("HealthPack.png"));
		image = icon.getImage();
	...
	/**
	 * This method is used to increase the ship's health.  The health pack will
	 * increase the ship's health by 50 with the maximum health being 100.
	 * 
