...
/**
 * This class extends PowerUp and provides a way for the ship to acquire a new weapon.
 * If the ship collides with the image produced by this class it will either gain an 
...
public class FlamePack extends PowerUp 
{
	...
	public FlamePack(JTypeSpace space, int x, int y)
	{
		...
		score = 10;
		hp = 1;
		ImageIcon icon = new ImageIcon(this.getClass().getResource("FireballPack.png"));
		image = icon.getImage();
