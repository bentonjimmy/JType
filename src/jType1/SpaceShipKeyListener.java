 ...
 * certain ship methods depending on the button pressed.  The W, A, S, D
 * keys are used to move up, left, down and right, respectively, while the 
...
public class SpaceShipKeyListener implements KeyListener
{
	...
	/**
	 * This method calls the appropriate method that is used to move the ship in 
