...
/**
 * SpaceMine extends DangerousObject and the SpaceMine image to the screen.  The class contains 
...
public class SpaceMine extends DangerousObject 
{
	public SpaceMine(JTypeSpace space, int x, int y)
	{
		...
		hp = 1;
		damage = 10;
		ImageIcon icon = new ImageIcon(this.getClass().getResource("SpaceMine.png"));
		image = icon.getImage();
