...
/**
 * Interface that defines SpaceObject which is implemented by most of the objects in the game.  It
 * provides for basic method signatures that are needed by most of the objects in the game.
 * 
 * @author jmb66
 *
 */
