...
/**
 * The MissileShot extends AbstractShot and creates a new Shot.  The shot moves across the screen
 * from left to right and defines methods that test if the shot hit any objects.
 * @author jmb66
 *
 */
