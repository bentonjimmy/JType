...
/**
 * Extends the AbstractSpaceAlien to create a space alien.  The alien will move up and down the screen
 * while slowly moving forward.  How often it shoots is defined in the constructor by the <code>shootVar</code>.
 * It is basically the same as SpaceAlien1 except that is shoots more often and has more life.
 * 
 * @author jmb66
 *
 */
public class SpaceAlien2 extends AbstractSpaceAlien 
{
	public SpaceAlien2(JTypeSpace space, int x, int y)
	{
		...
		score = 10;
		hp = 2;
		ImageIcon icon = new ImageIcon(this.getClass().getResource("LevelOneB.png"));
		image = icon.getImage();
