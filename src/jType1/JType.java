...
/**
 * The main class of this game.  It creates the JType object which extends JFrame.
...
public class JType extends JFrame 
{
	...
	/**
	 * Creates the toolbar on the left side of the screen that provides buttons to select
	 * which Gun is currently in use.
	 * 
	 * @param toolListener - ActionListener to is used to tell when a button is pressed
	...
	/**
	 * This creates the menu bar at the top of the screen.  This is where the player can reset the game
