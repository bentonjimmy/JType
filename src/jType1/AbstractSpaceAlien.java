...
/**
 * Abstract Space Alien class implements the SpaceObject interface and defines basic methods that 
 * each Alien type will have.  It provides the abstract method <code>shoot</code> that must be
