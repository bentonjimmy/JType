...
/**
 * This class is used to hold the contents of a level in the game.  A level is created
 * by setting the maxAliens value, which determines how many aliens will be on screen
 * at once, and then adding different Space Objects to the levelObjects List.  The order
 * that they are entered into the list determines the point that they appear in the game.
 * 
 * @author Jim Benton
 *
 */
