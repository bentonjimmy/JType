...
public class FactoryLevelBuilderTest {
	...
	public void testAddEnemy() 
	{
		...
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof SpaceAlien3);
		i = builder.getLevel().getTotalSize();
		builder.addEnemy("SpaceAlien2", 400);
		assertTrue((i+1) == builder.getLevel().getTotalSize());
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof SpaceAlien2);
		i = builder.getLevel().getTotalSize();
		builder.addEnemy("SpaceAlien1", 400);
		assertTrue((i+1) == builder.getLevel().getTotalSize());
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof SpaceAlien1);
	}
	...
	public void testAddPowerUp() 
	{
		...
		assertTrue((i+1) == builder.getLevel().getTotalSize());
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof FlamePack);
		i = builder.getLevel().getTotalSize();
		builder.addPowerUp("MissilePack", 400);
		assertTrue((i+1) == builder.getLevel().getTotalSize());
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof MissilePack);
		i = builder.getLevel().getTotalSize();
		builder.addPowerUp("HealthPack", 400);
		assertTrue((i+1) == builder.getLevel().getTotalSize());
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof HealthPack);
	}
	...
	public void testAddDangerousObject() 
	{
		...
		assertTrue((i+1) == builder.getLevel().getTotalSize());
		assertTrue(builder.getLevel().getSpaceObjectAt(i) instanceof SpaceMine);
	}
